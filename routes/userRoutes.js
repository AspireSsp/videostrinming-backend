...
const { register, login, updateUser, getUser, logout, updatePassword, getallUser, getfollower } = require('../controller/user');
...
router.route("/getfollowing/:id").get(getfollower);
